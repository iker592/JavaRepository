...
public class GenericArrayStackwithIterator <T> implements StackADT<T>,Iterable<T>
{
  /**
   ...
   */
  public GenericArrayStackwithIterator()
  {
    top = 0;
   ...
   */
  public GenericArrayStackwithIterator (int initialCapacity)
  {
    top = 0;
...
public class GenericArrayStackIterator implements Iterator<T> {
