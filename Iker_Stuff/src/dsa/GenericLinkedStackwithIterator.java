...
public class GenericLinkedStackwithIterator<T> implements StackADT<T>, Iterable<T> //,not Iterator<T>
{
   ...
   */
  public GenericLinkedStackwithIterator()
  { count = 0;
    top = null;
  }
...
//here we build the default iterator

public Iterator<T> iterator()  { return new GenericLinkedIterator(); }

private class GenericLinkedIterator implements Iterator<T> { 
