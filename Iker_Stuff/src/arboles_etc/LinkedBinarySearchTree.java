                                  ...
                                  implements BinarySearchTreeADT<T>
{
    ...
    */
   public T removeElement (T targetElement) //review
    ...
    */
   public T removeMin() throws EmptyCollectionException //02_11_15 monday
   {  T result = null;
      ...
      {  if (root.left == null) 
         ...
         {  BinaryTreeNode<T> parent = root;//keep track of the parent
            BinaryTreeNode<T> current = root.left;
            while (current.left != null) //find the element that's more at the left
            {  parent = current;
               current = current.left;
            }
            result =  current.element;
   ...
   public T find (T targetElement) throws ElementNotFoundException 
   {
      ...
      if (!(current.element.equals(targetElement)))//because in the else if may happen that the current.right!=null doesnt fit
         throw new ElementNotFoundException ("binary search tree");
   ...
   {
      BinaryTreeNode<T> current = next;//this sentence can be deleted
   ...
   public boolean contains(T targetElement){//done by myself in class
	   boolean found;
	   try {
		find(targetElement);
		found=true;
